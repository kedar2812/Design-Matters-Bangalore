 ...
 * Component from Skiper UI (https://skiper-ui.com/v1/skiper26), vendored
 * with the demo scaffolding removed; animation code unchanged.
 * Orignal concept from rudrodip — https://github.com/rudrodip/theme-toggle-effect
